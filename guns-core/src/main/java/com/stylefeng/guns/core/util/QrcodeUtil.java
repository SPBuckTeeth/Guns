...
public class QrcodeUtil {
	...
	public static String createQrcode(String url) throws IOException, WriterException {
		int qrcodeWidth = 300;
		...
		File QrcodeFile = new File("E:\\test\\qode\\" + new IdWorker().getId() + "." + qrcodeFormat);
	...
	public static String encode(String content, String imgPath, String destPath, boolean needCompress) throws Exception {
		...
		File dFile=new File(destPath + "/" + file);
		ImageIO.write(image, FORMAT_NAME,dFile );
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(encode(text, "E:/test/Desert.jpg", "C:/Users/admin/Pictures/a", true));
	}

	/**
	 * 生成 BufferedImage 类型的二维码
	 * @param content
	 * @param needCompress
	 * @return BufferedImage
	 * @throws Exception
	 */
	public static BufferedImage encodeQrWebImg(String content, boolean needCompress) throws Exception {
